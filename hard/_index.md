...
* [Clock Signal](https://github.com/TomHarte/CLK) — мультисистемный эмулятор под Мак. В числе прочего эмулирует ZX Spectrum, ZX80/81
* [Pantheon](https://bostjan-grandovec.si/Content/News.html) — closed-source, multi-system emulator for Windows covering many old computers and 1970s–1980s consoles. [Web version](https://bostjan-grandovec.si/pantheon/index.html) — Only supports Atari 2600/VCS, ColecoVison, Commodore PET, SEGA SG-1000, SEGA Master System, Sinclair ZX80/81, ZX Spectrum
* [EMU](https://bashkiria-2m.narod.ru/index/emul/0-8) — универсальный эмулятор старых компьютеров, включая ZX Spectrum 48/128 (частичная поддержка) для ОС Windows
...
* [ZXVita](https://www.rinnegatamante.eu/vitadb/#/info/478) — Sinclair ZX Spectrum 48k emulator for the PSVita
* [Fuse PSP](http://psp.akop.org/fuse.htm) — Sinclair Spectrum emulator for PlayStation Portable
* [Foon](http://www.codepuppies.com/ben/sens/gba/mirror/about.html) — ZX-Spectrum emulator for the Game Boy Advance
...
* [ZX Dream](https://zx.researcher.su/) — online emulator ZX Spectrum in JavaScript. 48/128/512/TR-DOS/Kempston mouse/TRD, FDI, SCL, TD0, UDI/AY-3-891x/YM2149 (+ Beeper, + Turbo Sound)
